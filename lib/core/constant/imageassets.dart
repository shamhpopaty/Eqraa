...
// Common images
  ...
  static String onBoardingSubtract = '$rootImage/img_subtract.svg';
  static String onBoardingButtonNext = '$rootImage/Vector.svg';
  static String onboardingbutton = '$rootImage/MoveButton.svg';
  ...
  static const String logos = "$rootLottie/logo.json";
